...
<section class="ji gp uq">
    ...
    <div class="bb ye ki xn vq jb jo">
        ...
        <div class="animate_top sg vk rm xm">
            ...
            <img class="w-full" src="{{ Vite::asset('resources/images/front/blog-01.png') }}" alt="Blog" />
            ...
            <div class="tc uf wf ag jq">
                <div class="tc wf ag">
                <img src="{{ Vite::asset('resources/images/front/icon-man.svg') }}" alt="User" />
                <p>Musharof Chy</p>
                </div>
                <div class="tc wf ag">
                <img src="{{ Vite::asset('resources/images/front/icon-calender.svg') }}" alt="Calender" />
                <p>25 Dec, 2025</p>
                </div>
            </div>
        ...
        <div class="animate_top sg vk rm xm">
            <div class="c rc i z-1 pg">
            <img class="w-full" src="{{ Vite::asset('resources/images/front/blog-02.png') }}" alt="Blog" />
        ...
        <div class="animate_top sg vk rm xm">
            <div class="c rc i z-1 pg">
            <img class="w-full" src="{{ Vite::asset('resources/images/front/blog-03.png') }}" alt="Blog" />
