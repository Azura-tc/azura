...
<section id="support" class="i pg fh rm ji gp uq">
        <!-- Bg Shapes -->
        <img src="{{ Vite::asset('resources/images/front/shape-06.svg') }}" alt="Shape" class="h aa y" />
        <img src="{{ Vite::asset('resources/images/front/shape-03.svg') }}" alt="Shape" class="h ca u" />
        <img src="{{ Vite::asset('resources/images/front/shape-07.svg') }}" alt="Shape" class="h w da ee" />
        <img src="{{ Vite::asset('resources/images/front/shape-12.svg') }}" alt="Shape" class="h p s" />
        <img src="{{ Vite::asset('resources/images/front/shape-13.svg') }}" alt="Shape" class="h r q" />
    ...
    <div class="i va bb ye ki xn wq jb mo">
        ...
        <div class="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg">
            <!-- Bg Shapes -->
            <img src="{{ Vite::asset('resources/images/front/shape-03.svg') }}" alt="Shape" class="h la x wd" />
            <img src="{{ Vite::asset('resources/images/front/shape-06.svg') }}" alt="Shape" class="h la ma ne kf" />
