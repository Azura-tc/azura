        ...
        <div class="tc uf zo xf ap zf bp mq">
            ...
            <div class="animate_top kn to/3 tc cg oq">
                <div class="tc wf xf cf ae cd rg mh">
                    <img src="{{ Vite::asset('resources/images/front/icon-01.svg') }}" alt="Icon" />
                </div>
                <div>
            ...
            <div class="animate_top kn to/3 tc cg oq">
                <div class="tc wf xf cf ae cd rg nh">
                    <img src="{{ Vite::asset('resources/images/front/icon-02.svg') }}" alt="Icon" />
                </div>
                <div>
            ...
            <div class="animate_top kn to/3 tc cg oq">
                <div class="tc wf xf cf ae cd rg oh">
                    <img src="{{ Vite::asset('resources/images/front/icon-03.svg') }}" alt="Icon" />
                </div>
                <div>
