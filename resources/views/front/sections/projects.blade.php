    ...
    <div class="bb ze ki xn 2xl:ud-px-0 jb" x-data="{filterTab: 1}">
        ...
        <div class="projects-wrapper tc -ud-mx-5">
            ...
            <div class="c i pg sg z-1">
                <img src="{{ Vite::asset('resources/images/front/project-01.png') }}" alt="Project" />
            ...
            <div class="c i pg sg z-1">
                <img src="{{ Vite::asset('resources/images/front/project-02.png') }}" alt="Project" />
            ...
            <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
            <div class="c i pg sg z-1">
                <img src="{{ Vite::asset('resources/images/front/project-04.png') }}" alt="Project" />
            ...
            <div class="c i pg sg z-1">
                <img src="{{ Vite::asset('resources/images/front/project-03.png') }}" alt="Project" />
