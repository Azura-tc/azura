    ...
    <div class="bb ze ki xn 2xl:ud-px-0">
        ...
        <div class="ji gp">
            <div class="tc uf ap gg fp">
                ...
                <a href="index.html">
                    <img src="{{ Vite::asset('resources/images/front/logo-light.svg') }}" alt="Logo" class="om" />
                    <img src="{{ Vite::asset('resources/images/front/logo-dark.svg') }}" alt="Logo" class="xc nm" />
                </a>
