...
>
  <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
    <div class="vd to/4 tc wf yf">
      <a href="index.html">
        <img class="om" src="{{ Vite::asset('resources/images/front/logo-light.svg') }}" alt="Logo Light" />
        <img class="xc nm" src="{{ Vite::asset('resources/images/front/logo-dark.svg') }}" alt="Logo Dark" />
      </a>
    ...
    >
      <nav>
        <ul class="tc _o sf yo cg ep">
          ...
          <li><a href="#about" class="xl">A propos</a></li>
          <li><a href="#services" class="xl">Services</a></li>
          <li><a href="#pricing" class="xl">Nos Tarifs</a></li>
          <li><a href="#gallery" class="xl">Gallerie</a></li>
      ...
      <div class="tc wf ig pb no">
        <div class="pc h io pa ra" :class="navigationOpen ? '!-ud-visible' : 'd'">
          <label class="rc ab i">
            ...
            <!-- Icon Sun -->
            <img class="xc nm" src="{{ Vite::asset('resources/images/front/icon-moon.svg') }}" alt="Moon" />
          </label>
        </div>

        <!-- <a href="signin.html" :class="{ 'nk yl' : page === 'home', 'ok' : page === 'home' && stickyMenu }" class="ek pk xl">Sign In</a> -->
        <a href="signup.html" :class="{ 'hh/[0.15]' : page === 'home', 'sh' : page === 'home' && stickyMenu }" class="lk gh dk rg tc wf xf _l gi hi">Nous contacter</a>
      </div>
    </div>
  </div>
</header>
